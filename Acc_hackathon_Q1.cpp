                                          ...
                                          tuple<string, double, double, double, double> car2)
{
    ...
    double a = velDifX * velDifX ;
    double b = 2 * (posDifX * velDifX);
    double c = posDifX * posDifX - 100;
...
int main()
{
    vector<tuple<string, double, double> > collectionOfCars; //All info of cars
    ...
    { //read in info about cars
        collectionOfCars.push_back(make_tuple(xPos, xVel));
    }
